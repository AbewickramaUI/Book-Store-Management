...
<body onload="showSlides()">
	...
	<br><br><br><br><br><br>
	 <div class="card">
  <img src="Img/s19.jpg" alt="Talking Heads" style="width:100%">
  <h2>Factory Rest</h2>
  <h5>Carolina Paramita</h5>
  <p class="price">Rs:710</p>
  <p>ISBM-000019</p>
    <p><button id="myButton24">Add to Cart</button>
		 <script type="text/javascript">
    		document.getElementById("myButton24").onclick = function () {
		 ...
		 <div class="card">
  <img src="Img/s20.jpg" alt="Our Last Summer" style="width:100%">
  <h2>Medusa</h2>
  <h5>Chad Gibbons</h5>
  <p class="price">Rs:920</p>
  <p>ISBM-000020</p>
    <p><button id="myButton25">Add to Cart</button>
		 <script type="text/javascript">
    		document.getElementById("myButton25").onclick = function () {
        		alert('Do you want to add this book to the cart');
				location.href = "cart.php";
    		};
</script>	 
		 ...
		 <div class="card">
  <img src="Img/s21.jpg" alt="Love at first sight" style="width:100%">
  <h2>Digital World</h2>
  <h5>Donna Stroupe</h5>
  <p class="price">Rs:600</p>
  <p>ISBM-000021</p>
      <p><button id="myButton26">Add to Cart</button>
		 <script type="text/javascript">
    		document.getElementById("myButton26").onclick = function () {
        		alert('Do you want to add this book to the cart');
				location.href = "cart.php";
    		};
</script>	 
		 ...
		 <div class="card">
  <img src="Img/s22.jpg" alt="The Last Summer" style="width:100%">
  <h2>Tera Ascending</h2>
  <h5>Max Banks</h5>
  <p class="price">Rs:720</p>
  <p>ISBM-000022</p>
    <p><button id="myButton27">Add to Cart</button>
		 <script type="text/javascript">
    		document.getElementById("myButton27").onclick = function () {
        		alert('Do you want to add this book to the cart');
				location.href = "cart.php";
    		};
</script>	 
		 ...
		 <div class="card">
  <img src="Img/s23.jpg" alt="When We First Met" style="width:100%">
  <h2>A Big bubble</h2>
  <h5>Estelle Darcy</h5>
  <p class="price">Rs:655</p>
  <p>ISBM-000023</p>
      <p><button id="myButton28">Add to Cart</button>
		 <script type="text/javascript">
    		document.getElementById("myButton28").onclick = function () {
        		alert('Do you want to add this book to the cart');
				location.href = "cart.php";
    		};
</script>	 
