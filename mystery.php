...
<body onload="showSlides()">
	...
	<br><br><br><br><br><br>
	 <div class="card">
  <img src="Img/m35.jpg" alt="Talking Heads" style="width:100%">
  <h2>Breaking</h2>
  <h5>Kim Chun Hei</h5>
  <p class="price">Rs:665</p>
  <p>ISBM-000035</p>
      <p><button id="myButton30">Add to Cart</button>
		 <script type="text/javascript">
    		document.getElementById("myButton30").onclick = function () {
...
<div class="card">
  <img src="Img/m36.jpg" alt="Talking Heads" style="width:100%">
  <h2>Lost Girl</h2>
  <h5>Mark Fitz</h5>
  <p class="price">Rs:800</p>
  <p>ISBM-000036</p>
      <p><button id="myButton31">Add to Cart</button>
		 <script type="text/javascript">
    		document.getElementById("myButton31").onclick = function () {
        		alert('Do you want to add this book to the cart');
				location.href = "cart.php";
    		};
</script>	 
...
<div class="card">
  <img src="Img/m37.jpg" alt="Talking Heads" style="width:100%">
  <h2>Dark Side</h2>
  <h5>Morgan Maxwell</h5>
  <p class="price">Rs:820</p>
  <p>ISBM-000037</p>
      <p><button id="myButton32">Add to Cart</button>
		 <script type="text/javascript">
    		document.getElementById("myButton32").onclick = function () {
        		alert('Do you want to add this book to the cart');
				location.href = "cart.php";
    		};
</script>	 
